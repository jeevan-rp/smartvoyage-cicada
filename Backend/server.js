...
admin.initializeApp({
  ...
  databaseURL: process.env.FIREBASE_DATABASE_URL || `https://${process.env.FIREBASE_PROJECT_ID || 'smart-voyage-cicada'}-default-rtdb.firebaseio.com`,
  storageBucket: process.env.GCS_BUCKET_NAME || `${process.env.FIREBASE_PROJECT_ID || 'smart-voyage-cicada'}.appspot.com`
});
